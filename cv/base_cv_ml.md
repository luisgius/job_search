...
focused on taking machine learning models from prototype to production. Built
and deployed an end-to-end forecasting system at Uber — feature pipelines,
validation design and a shadow-to-live rollout — replacing an incumbent manual
process, and shipped predictive models at Buynomics for Tier-1 CPG clients.
Comfortable across the stack: large-scale data (SQL, Presto, Spark), modelling
(LightGBM, PyTorch) and deployment (FastAPI, Docker).
