...
working where analytics meets product decisions. Applies experimental design,
causal inference and rigorous evaluation to turn open business questions into
measurable outcomes — from forecast metrics adopted by operations teams at
Uber to model benchmarking for Tier-1 CPG clients at Buynomics. Strong SQL and
large-scale data skills, paired with a business background and a track record
of communicating results to non-technical stakeholders.
